...
if __name__ == "__main__":
    ...
    fixedRateNet = Network("273927.json", 10, "fixed-rate")
    flexRateNet = Network("273927.json", 10, "flex-rate")
    shannonNet = Network("273927.json", 10, "shannon")
    ...
    for transceiver in transceivers:
        ...
        for m in range(1, 80):
            ...
            net = Network("273927.json", 10, transceiver)  # resetting the network
